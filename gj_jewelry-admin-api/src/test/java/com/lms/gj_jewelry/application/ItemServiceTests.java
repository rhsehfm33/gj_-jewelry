...
public class ItemServiceTests {
    ...
    public void testUpdateItem() {
        ...
        given(itemRepository.findById(originalItem.getId())).willReturn(Optional.of(originalItem));
        given(itemRepository.save(originalItem)).willReturn(updatedItem);
        Item resultItem = itemService.updateItem(originalItem);
        assertThat(resultItem, is(updatedItem));
    }
    ...
    public void testDeleteItem() {
        ...
        Long targetItemId = targetItem.getId();
        given(itemRepository.findById(targetItemId)).willReturn(Optional.of(targetItem));
        itemService.deleteItem(targetItemId);
        assertTrue(targetItem.isDeleted());
    }
